...
public class BillCalculation
{
    ...
    private int planFee = 0;   //计划费用

    private int talkTime = 0;   //对话时间

    private int flow = 0;       //流动，流量

    private int callViewTime = 0;   //视频通话时间？

    private double talkTimePer = 0;  //每分钟费用？															

    private double flowPer = 0.3;    //流量每兆费用？

    private double viewPer = 0.6;

    private int talkTimeBench = 0;  //套餐内通话时长？

    private int flowBench = 0;    //套餐内流量
