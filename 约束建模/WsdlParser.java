...
public class WsdlParser {
	...
	public java.util.List<OperationInfo> parseWsdl(String wsdlUrl) {
...
//		
//		System.out.println();
//		System.out.println("ZZQ Test:");
//		for (OperationInfo oi : opList){
//			System.out.println(oi.getOpName());
//			java.util.List<ParameterInfo> tpil = oi.getParaList();
//			for(ParameterInfo pi : tpil) {
//				System.out.print(pi.getId());
//				System.out.print("\t:\t");
//				System.out.print(pi.getType());
//				System.out.print("\t");
//				System.out.println(pi.getRestriction());
//			}
//			System.out.println();
//		}
//		
	...
	public static void main(String[] args) {
		...
		wp.parseWsdl("http://127.0.0.1:8080/axis2/services/ATMService?wsdl");
	}
