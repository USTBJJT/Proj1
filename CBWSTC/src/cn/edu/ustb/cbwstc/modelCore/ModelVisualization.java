...
public class ModelVisualization {
	...
	public void visualizationGen(String name) {
		...
		String file = System.getProperty("user.dir") + separator 
				...
				+"Model" + separator 
				+ "ModelPng.txt";
		String pic = System.getProperty("user.dir") + separator 
				+ "CBWSTC_WorkSpace" + separator 
				+ "Projects" + separator 
				+ name + separator 
				+"Model" + separator 
		...
		String cmd = "dot -Tpng " + file + " -o " + pic;
		InvokeCmd genPic = new InvokeCmd();
		genPic.execCmd(cmd);
	}
	
	public void imageView(String name) {
		String separator = File.separator;
		String pic = System.getProperty("user.dir") + separator 
				+ "CBWSTC_WorkSpace" + separator 
				+ "Projects" + separator 
				...
				+"Model" + separator 
				+ "ModelPng.png";
		String cmd = "rundll32 c:\\Windows\\System32\\shimgvw.dll,ImageView_Fullscreen " + pic;
		InvokeCmd genPic = new InvokeCmd();
		genPic.execCmd(cmd);
	}
