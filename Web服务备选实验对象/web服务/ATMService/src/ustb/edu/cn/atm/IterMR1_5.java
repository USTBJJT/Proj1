...
public class IterMR1_5 {
	...
	public static void main(String[] args) {
		...
		IterMR1_5 test = new IterMR1_5();
		List<String> listFileNames=test.getFileNames();
		
		test.invokeATM(listFileNames,50);
	...
	public void invokeATM(List<String> listFileNames,int num){
		...
		while(iterFile.hasNext()){
			...
			try {
				...
				Map map=genTCF_MR1_5(listS,num);				
	...
	public void writeResultFile(Map<String, List> map,String fileName) {
		...
		try {
			File f = new File("D:\\Iter\\MR1_5\\result_total_50\\" + fileName + ".txt");
			if (f.exists()) {
	...
	public void writeCountFile(Map<String,List> mapCount){
		...
		try {
			File f = new File("D:\\Iter\\MR1_5\\result_total_50\\totalCount.txt");
			if (f.exists()) {
				System.out.println("文件存在");
			} else {
				System.out.println("文件不存在");
	...
	public void writeTCFile(Map<List<String>, List<String>> map,String fileName) {
		...
		try {
			File f = new File("D:\\Iter\\MR1_5\\testcase_total_50\\" + fileName + ".txt");
			if (f.exists()) {
				System.out.println("文件存在");
			} else {
				System.out.println("文件不存在");
